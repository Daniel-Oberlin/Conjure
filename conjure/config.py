...
class Settings:
    ...
    # stored entity ~10 cm high, so everything in that room renders above the real floor and objects placed
    # there visibly float. Measured, reproduced, and NOT curable by a Room Setup re-scan. This is the one
