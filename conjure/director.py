...
DIRECTOR_PROMPT = (
    ...
    "skybox_from_scene_image to turn it into the sky. Don't pick an image generator unless the user "
    "asked for a specific one — omit it and the best default is used. "
