...
DIRECTOR_PROMPT = (
    ...
    "'all'; pass repeat=N with a seamless/tileable image to tile it (grass, brick). Don't pick an "
    "image generator unless the user asked for a specific one — omit it and the best default is used. "
