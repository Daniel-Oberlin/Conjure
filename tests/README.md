...
| `test_llm.py` | LLM roster + image generators: attribution, Claude/Gemini/OpenAI tool loops (faked SDKs), capabilities, `select_generator` mediation, OpenAI image gen |
